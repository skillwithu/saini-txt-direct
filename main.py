...
f"💫 𝐄.𝐠: 𝐍𝐚𝐦𝐞: 𝐋𝐢𝐧𝐤")
    ...
    await editable.edit("__📺 𝐏𝐥𝐞𝐚𝐬𝐞 𝐏𝐫𝐨𝐯𝐢𝐝𝐞 𝐂𝐡𝐚𝐧𝐧𝐞𝐥 𝐢𝐝 𝐨𝐫 𝐰𝐡𝐞𝐫𝐞 𝐲𝐨𝐮 𝐰𝐚𝐧𝐭 𝐭𝐨 𝐔𝐩𝐥𝐨𝐚𝐝 𝐯𝐢𝐝𝐞𝐨 𝐨𝐫 𝐒𝐞𝐧𝐭 𝐕𝐢𝐝𝐞𝐨 𝐨𝐭𝐡𝐞𝐫𝐰𝐢𝐬𝐞 /d __\n\n__⚠️ 𝐀𝐧𝐝 𝐦𝐚𝐤𝐞 𝐦𝐞 𝐚𝐝𝐦𝐢𝐧 𝐢𝐧 𝐭𝐡𝐢𝐬 𝐜𝐡𝐚𝐧𝐧𝐞𝐥 𝐭𝐡𝐞𝐧 𝐢 𝐜𝐚𝐧 𝐚𝐛𝐥𝐞 𝐭𝐨 𝐔𝐩𝐥𝐨𝐚𝐝 𝐨𝐭𝐡𝐞𝐫𝐰𝐢𝐬𝐞 𝐢 𝐜𝐚𝐧'𝐭"__)
